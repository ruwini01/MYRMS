...
#pragma warning disable CS0169 // The field 'formCart.formMenu' is never used
        private formMenu formMenu;
#pragma warning restore CS0169 // The field 'formCart.formMenu' is never used
        ...
        public formCart(frmMain m)
        {
            main = m;
            InitializeComponent();
        }

        public formCart(formMenu m)
        {
            menu = m;
            InitializeComponent();
        }
